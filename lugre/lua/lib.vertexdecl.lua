...
-- ***** ***** ***** workaround for renderqueue constants
-- can be removed later : lugre_luabinds_ogre.cpp will generate them once a new compiled binary is available (12.09.2010)

if (not RENDER_QUEUE_BACKGROUND) then
