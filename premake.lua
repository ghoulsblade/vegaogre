...
gAdditionalCompileFlags = os.getenv("VEGAOGRE_COMPILE_FLAGS") -- environment variable
gVegaOgreMainWorkingDir = os.getenv("VEGAOGRE_MAIN_WORKING_DIR") or ".."
...
addoption("mainworkingdir","specify the main working dir used by vegaogre (for readonly install dir)")
...
if (options["mainworkingdir"]) then 	gVegaOgreMainWorkingDir = options["mainworkingdir"] end

print("gVegaOgreMainWorkingDir=","#"..gVegaOgreMainWorkingDir.."#")
